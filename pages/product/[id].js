        ...
        <div className="detail-section">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p>
                Conducted thorough reviews of potential business partnerships
                and strategies, and performed risk analysis using Facilitated
                Risk Analysis Process (FRAP) Trained and supervised 2 new
                employees, ensuring they maintain high attention to detail
                Forecast losses and earnings using quantitative/qualitative
                analyses to a high degree of accuracy, allowing the company to
                intelligently manage and invest resources valued at $14 million
                Adhered to departmental controls and regulations and maintained
                ethical conduct at all times
              </p>
            </div>
          </div>
          <CategoryProducts h="Related Products"/>
        </div>
      </div>
    </>
  );
